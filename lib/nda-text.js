...
THIS AGREEMENT is entered into between AMPTD LLC, an Arizona limited liability
company ("Company") and the individual or
...
15.5 This Agreement is governed by the laws of the State of Arizona, without
 ...
 * executions. Move the outgoing AGREEMENT_TEXT here on every bump.
 *
 * 1.0.0 is retained verbatim, placeholders and all. Nobody executed it, but the
 * rule is that a version is never deleted once shipped — the moment an exception
 * is made is the moment a countersigned PDF stops resolving.
 * @type {Record<string, string>}
 */
const TEXT_1_0_0 = `MUTUAL CONFIDENTIALITY AND IDEA PROTECTION AGREEMENT
Version 1.0.0
 ...
 * CHANGELOG
 *
 * 1.1.0 — Named the actual contracting party. [BRAND] became "AMPTD LLC, an
 *         Arizona limited liability company" and [GOVERNING_JURISDICTION] became
 *         "the State of Arizona". Until this bump the Company side of the
 *         agreement was a placeholder string, so no execution could bind anyone.
 *         A d/b/a can be added in a later version once the brand is chosen; the
 *         legal entity is what makes the agreement enforceable, not the trade name.
 *
 * 1.0.0 — Initial version. Contained [BRAND] and [GOVERNING_JURISDICTION]
 *         placeholders. Never executed by anyone.
 */
